...
public class ObservableGroupTest {
    ...
    @Test
    public void shouldNotBeCompleted() {
        ObservableGroup group = observableManager.newGroup();
    ...
    @Test
    public void shouldDeliverSuccessfulEvent() throws Exception {
        ObservableGroup group = observableManager.newGroup();
    ...
    @Test
    public void shouldDeliverError() throws Exception {
        ObservableGroup group = observableManager.newGroup();
    ...
    @Test
    public void shouldSeparateObservablesByGroupId() {
        ObservableGroup group = observableManager.newGroup();
        ObservableGroup group2 = observableManager.newGroup();
    ...
    @Test
    public void shouldClearObservablesByGroupId() {
        ObservableGroup group = observableManager.newGroup();
        ObservableGroup group2 = observableManager.newGroup();
        Observable<String> observable1 = Observable.never();
        Observable<String> observable2 = Observable.never();
    ...
    @Test
    public void shouldClearObservablesWhenLocked() {
        ObservableGroup group = observableManager.newGroup();
        Observable<String> observable1 = Observable.never();
        Observable<String> observable2 = Observable.never();
        TestObserver<String> subscriber1 = new TestObserver<>();
    ...
    @Test
    public void shouldClearQueuedResults() throws Exception {
        ObservableGroup group = observableManager.newGroup();
        PublishSubject<String> subject = PublishSubject.create();
        TestObserver<String> subscriber1 = new TestObserver<>();
    ...
    @Test
    public void shouldRemoveObservablesAfterTermination() throws Exception {
        ObservableGroup group = observableManager.newGroup();
        PublishSubject<String> subject = PublishSubject.create();
        TestObserver<String> subscriber = new TestObserver<>();
        group.add("foo", subject, subscriber);
    ...
    @Test
    public void shouldRemoveResponseAfterErrorDelivery() throws InterruptedException {
        ObservableGroup group = observableManager.newGroup();
        TestObserver<String> testObserver = new TestObserver<>();
        PublishSubject<String> subject = PublishSubject.create();
    ...
    @Test
    public void shouldNotDeliverResultWhileUnsubscribed() throws Exception {
        ObservableGroup group = observableManager.newGroup();
        TestObserver<String> testObserver = new TestObserver<>();
        PublishSubject<String> subject = PublishSubject.create();
    ...
    @Test
    public void shouldDeliverQueuedEventsWhenResubscribed() throws Exception {
        ObservableGroup group = observableManager.newGroup();
        TestObserver<String> testObserver = new TestObserver<>();
        PublishSubject<String> subject = PublishSubject.create();
        group.add("foo", subject, testObserver);
    ...
    @Test
    public void shouldDeliverQueuedErrorWhenResubscribed() throws Exception {
        ObservableGroup group = observableManager.newGroup();
        TestObserver<String> testObserver = new TestObserver<>();
        PublishSubject<String> subject = PublishSubject.create();
    ...
    @Test
    public void shouldNotDeliverEventsWhenResubscribedIfLocked() {
        ObservableGroup group = observableManager.newGroup();
        TestObserver<String> testObserver = new TestObserver<>();
        PublishSubject<String> subject = PublishSubject.create();
        group.add("foo", subject, testObserver);
    ...
    @Test
    public void shouldUnsubscribeByContext() throws Exception {
        ObservableGroup group = observableManager.newGroup();
        ObservableGroup group2 = observableManager.newGroup();
        PublishSubject<String> subject = PublishSubject.create();
        TestObserver<String> testObserver = new TestObserver<>();
    ...
    @Test
    public void shouldNotDeliverEventsAfterCancelled() throws Exception {
        ObservableGroup group = observableManager.newGroup();
        PublishSubject<String> subject = PublishSubject.create();
        TestObserver<String> testObserver = new TestObserver<>();
    ...
    @Test
    public void shouldNotRemoveSubscribersForOtherIds() throws Exception {
        ObservableGroup group = observableManager.newGroup();
        ObservableGroup group2 = observableManager.newGroup();
    ...
    @Test
    public void shouldOverrideExistingSubscriber() throws Exception {
        ObservableGroup group = observableManager.newGroup();
        PublishSubject<String> subject = PublishSubject.create();
        TestObserver<String> testSubscriber1 = new TestObserver<>();
        TestObserver<String> testSubscriber2 = new TestObserver<>();
    ...
    @Test
    public void shouldQueueMultipleRequests() throws Exception {
        ObservableGroup group = observableManager.newGroup();
        PublishSubject<String> subject1 = PublishSubject.create();
        TestObserver<String> testSubscriber1 = new TestObserver<>();
        PublishSubject<String> subject2 = PublishSubject.create();
    ...
    @Test
    public void shouldNotDeliverResultWhileLocked() throws Exception {
        ObservableGroup group = observableManager.newGroup();
        TestObserver<String> testObserver = new TestObserver<>();
        PublishSubject<String> subject = PublishSubject.create();
    ...
    @Test
    public void shouldAutoResubscribeAfterUnlock() throws InterruptedException {
        ObservableGroup group = observableManager.newGroup();
        TestObserver<String> testObserver = new TestObserver<>();
        PublishSubject<String> subject = PublishSubject.create();
    ...
    @Test
    public void shouldAutoResubscribeAfterLockAndUnlock() {
        ObservableGroup group = observableManager.newGroup();
        TestObserver<String> testObserver = new TestObserver<>();
        PublishSubject<String> subject = PublishSubject.create();
    ...
    @Test
    public void testUnsubscribeWhenLocked() {
        ObservableGroup group = observableManager.newGroup();
        TestObserver<String> testObserver = new TestObserver<>();
        PublishSubject<String> subject = PublishSubject.create();
    ...
    @Test
    public void testAddThrowsAfterDestroyed() {
        ObservableGroup group = observableManager.newGroup();
        group.destroy();
        try {
    ...
    @Test
    public void testResubscribeThrowsAfterDestroyed() {
        ObservableGroup group = observableManager.newGroup();
        try {
            group.add("tag", PublishSubject.<String>create(), new TestObserver<>());
            group.unsubscribe();
    ...
    @Test
    public void shouldReplaceObservablesOfSameTagAndSameGroupId() {
        ObservableGroup group = observableManager.newGroup();
        Observable<String> observable1 = Observable.never();
    ...
    @Test
    public void testCancelAndReAddSubscription() {
        ObservableGroup group = observableManager.newGroup();
        group.add("tag", PublishSubject.<String>create(), new TestObserver<>());
