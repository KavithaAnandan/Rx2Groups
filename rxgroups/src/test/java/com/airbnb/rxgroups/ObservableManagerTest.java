...
public class ObservableManagerTest {
    ...
    @Test
    public void testGetGroupThrowsIfNonExistent() {
        try {
    ...
    @Test
    public void testGetGroupThrowsIfDestroyed() {
        try {
            ObservableGroup group = observableManager.newGroup();
            group.destroy();
            observableManager.getGroup(1);
    ...
    @Test
    public void testIdsAreNotReused() {
        for (int i = 1; i < 10; i++) {
            ObservableGroup group = observableManager.newGroup();
    ...
    @Test
    public void testGetGroupThrowsAfterDestroyed() {
        ObservableGroup group = observableManager.newGroup();
